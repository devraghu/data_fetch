...
def is_interesting(url: str) -> bool:
    lower = url.lower()
    return (
        "amfiindia.com" in lower
        and any(word.lower() in lower for word in INTERESTING_WORDS)
    )
...
async def main() -> None:
    ...
    async with async_playwright() as p:
        ...
        async def on_request(request):
            ...
            print("URL:", url)
            print("RESOURCE:", request.resource_type)
            if post_data:
                print("POST_DATA:", post_data[:1000])
        ...
        for url in PAGES:
            ...
            try:
                ...
                print("PAGE HTML SAVED:", page_file)
